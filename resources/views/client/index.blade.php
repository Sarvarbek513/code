            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn">
                    ...
                    <div class="d-flex align-items-center mt-4">
                        <a style="background-color: #FFD700;color: black;" class="btn btn-primary rounded-pill px-4 me-3" href="{{url('/about')}}">Biz haqimizda</a>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-equal">
                <div class="card card-custom">
                    ...
                    <div class="card-body card-body-custom">
                        ...
                        <h5 class="card-text"><a style="text-decoration: none;color: #6c757d" href="{{url('/home/maqola')}}">O'zbekistonda norasmiy bandlikning o'zgarish tendensiyalari</a></h5>
            ...
            <div class="col-md-4 col-equal">
                <div class="card card-custom">
                    ...
                    <div class="card-body card-body-custom">
                        ...
                        <h5 class="card-text"><a style="text-decoration: none;color: #6c757d" href="{{url('/home/maqola2')}}">O'zbekistonda nogironligi bo'lgan shaxslarning mehnat bozorida inklyuziv...</a></h5>
            ...
            <div class="col-md-4 col-equal">
                <div class="card card-custom">
                    ...
                    <div class="card-body card-body-custom">
                        ...
                        <h5 class="card-text"><a style="text-decoration: none;color: #6c757d" href="{{url('/home/maqola3')}}">Farzand tarbiyasi va kasb tanlashida ota-onalarning ishtiroki</a></h5>
                        <p class="text-muted">Ota-onalarning farzandi kelajagiga mas’uliyat bilan yondashuvi bolaning yaxshi kamol topishi va muvaffaqiyatga erishishidagi muhim omildir.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="d-flex align-items-center mt-4">
                        <a  class="btn btn-primary rounded-pill px-4 me-3" href="{{url('/team')}}">Batafsil</a>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="about-img">
            ...
            <div class="col-md-4 col-equal">
                <div class="card card-custom">
                    ...
                    <div class="card-body card-body-custom">
                        ...
                        <h5 class="card-text"><a style="text-decoration: none;color: #6c757d" href="{{url('/home/maqola4')}}">O'zbekistonda ayollar orasidagi ishsizlik sabablari</a></h5>
            ...
            <div class="col-md-4 col-equal">
                <div class="card card-custom">
                    ...
                    <div class="card-body card-body-custom">
                        ...
                        <h5 class="card-text"><a style="text-decoration: none;color: #6c757d" href="{{url('/home/maqola5')}}">Qaysi sohalarda ko'proq maosh taklif qilinmoqda?</a></h5>
            ...
            <div class="col-md-4 col-equal">
                <div class="card card-custom">
                    ...
                    <div class="card-body card-body-custom">
                        ...
                        <h5 class="card-text"><a style="text-decoration: none;color: #6c757d" href="{{url('/home/maqola6')}}">Mehnat bozorining hududiy indeksi: hududlarda vaziyat qanday?</a></h5>
    ...
    <div class="container-fluid bg-light py-5">
        <div class="container">
            <div class="container mt-5">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <button class="btn btn-custom" type="button"><h4><a style="text-decoration: none;color: black" href="{{url('/tarmoq/index')}}">Iqtisodiyot tarmoqlari</a></h4></button>
                    </div>
                    <div class="col-md-6">
                        <button class="btn btn-custom" type="button"><h4><a style="text-decoration: none;color: black" href="{{url('/statistic/index')}}">Mehnat bozori</a></h4></button>
                    </div>
                    <div class="col-md-6">
                        <button class="btn btn-custom" type="button"><h4><a style="text-decoration: none;color: black" href="{{url('/team')}}">Migratsiya</a></h4></button>
                    </div>
                    <div class="col-md-6">
                        <button class="btn btn-custom" type="button"><h4><a style="text-decoration: none;color: black" href="{{url('/maosh')}}">Kasblar</a></h4></button>
                    </div>
                    <div class="col-md-6">
                        <button class="btn btn-custom" type="button"><h4><a style="text-decoration: none;color: black" href="{{url('/404')}}">Ishga joylashish</a></h4></button>
                    </div>
                    <div class="col-md-6">
                        <button class="btn btn-custom" type="button"><h4><a style="text-decoration: none;color: black" href="{{url('/team')}}">Hududiy</a></h4></button>
                    </div>
                    <div class="col-md-6">
                        <button class="btn btn-custom" type="button"><h4><a style="text-decoration: none;color: black" href="{{url('/osish')}}">Ko`nikmalar</a></h4></button>
                    </div>
                    <div class="col-md-6">
                        <button class="btn btn-custom" type="button"><h4><a style="text-decoration: none;color: black" href="https://rank.uz/ru/ec">Trening</a></h4></button>
                    </div>
                </div>
            </div>
        </div>
