...
@section('content')
    ...
    <div style="padding-top: 70px;">
        <div class="p-5">
            <h3 style="color: #2f005f;" class="pt-5 pb-5">Keyingi 6 oyda talab yuqori bo`ladigan kasblar</h3>
            <hr class="mb-4">
            <p class="pb-3">Ish beruvchilar orasida o‘tkazilgan so‘rov natijalariga ko‘ra, keyingi 6 oyda IT-dasturchilariga, marketologlarga, buxgalterlarga, sotuvchilarga, kadrlar bo‘yicha xodimlarga va malaka talab etilmaydigan bog‘bon, haydovchi va farroshlarga talab yuqori bo‘lishi kutilmoqda.</p>
            <div class="row w-100">
                <div class="col-md-6">
                ...
                <div style="width: 10%" class="col-md-2">
                    <form action="{{ route('expects.index') }}" method="GET">
    ...
    <div class="p-5 pt-0">
        <div class="report-data mb-2 mt-3">
            ...
            {!! $expects->withQueryString()->links('pagination::bootstrap-5') !!}
        </div>
