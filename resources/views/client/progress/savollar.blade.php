...
@section('content')
    ...
    <div class="container mt-5 mb-5">
        <h3>Ko'p So'raladigan Ko'nikmalar</h3>
        <p>Quyidagi jadvalda 20 ta eng ko'p  so'raladigan ko'nikmalar keltirilgan.</p>
                ...
                @foreach($maoshes as $maoshe)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4" style="text-align: left; vertical-align: middle;">
                            ...
                            <p style="display: inline-block; margin-left: 10px; vertical-align: middle;font-size: 16px;">{{$maoshe->foiz}}%</p>
                        </td>
                    </tr>
                @endforeach
                </tbody>
