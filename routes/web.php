...
Route::get('home/maqola', function () {
    return view('client.maqolalar.home.maqola');
});
Route::get('home/maqola2', function () {
    return view('client.maqolalar.home.maqola2');
});
Route::get('home/maqola3', function () {
    return view('client.maqolalar.home.maqola3');
});
Route::get('home/maqola4', function () {
    return view('client.maqolalar.home.maqola4');
});
Route::get('home/maqola5', function () {
    return view('client.maqolalar.home.maqola5');
});
Route::get('home/maqola6', function () {
    return view('client.maqolalar.home.maqola6');
});
